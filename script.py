...
def queryDB(lists):
	...
	try:
		...
		cur = conn.cursor()
		querry = "Insert into historicalapplication values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
		print(lists)
...
def make_data(L):
	...
	colleges = ["Purdue", "UMich", "IU", "Penn State", "Rutgers", "Northwestern University", "Michigan State University", "University of Maryland", "UIUC", "OSU", "University of Wisconsin Madison", "Northwestern University", "University of Nebraska-Lincoln", "University of Minnesota Twin Cities", "University of Iowa", "UIUC"]
	...
	for j in range(0, L):
		...
		lists.append(round(normal(1.5, 4.0), 2))
		lists.append(colleges[randint(0, len(colleges) - 1)])
		lists.append(major[randint(0, len(major) - 1)])
		queryDB(lists)
addColumn("num_students", "int")
addColumn("num_ugrads", "int")
addColumn("num_postgrads", "int")
